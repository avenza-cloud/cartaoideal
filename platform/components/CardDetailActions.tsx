...
export function CardDetailActions({ cardId, sourceUrl }: CardDetailActionsProps) {
  ...
  return (
    <div className="fixed inset-x-3 bottom-safe z-40 mx-auto grid max-w-md grid-cols-3 gap-2 rounded-xl border bg-background/92 p-2 shadow-[0_18px_80px_rgba(0,0,0,0.45)] backdrop-blur">
      <Link
        href="/cartoes"
